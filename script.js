...
"m.desc":"Алматыда ПНД құбырларын өндіру: сумен жабдықтау, кәріз, кабель қорғау, фитингтер. Диаметрі 16-250 мм, SDR 9-26, 5 / 6 / 12 м кесінділер және орамдар. Нарықта 20 жылдан астам, қызмет мерзімі 50 жылдан астам. Құбырлар мен фитингтерді монтаждау. 50 позициялық прайс сайтта.",
...
"h.lead":"<b>Диаметрі 16-250 мм</b>, 5, 6 және 12 м кесінділер және орамдар. Сатамыз әрі монтаждаймыз. Метр бағасы - 75 ₸-ден, 50 позициялық прайс төменде.",
...
"p1.c1":"<b>Ø16-250</b> мм","p1.c2":"SDR 9-26 · 16 атм-ге дейін","p1.c3":"5 / 6 / 12 м және орамдар","p1.a":"Көк таңбалау жолағы бар сумен жабдықтауға арналған ПНД құбырлары жақын планда, ЭКО ПЛАСТ өндірісі","p1.cap":"ПЭ100 · көк жолақ · ауыз су",
...
"p2.c1":"<b>Ø50-250</b> мм","p2.c2":"SDR 17-26","p2.c3":"5 / 6 / 12 м кесінділер","p2.a":"Алматыдағы ЭКО ПЛАСТ қоймасында қатарланған үлкен диаметрлі ПНД құбырлары","p2.cap":"қойма · Алматы",
...
"ft.p":"Алматыда ПНД құбырлары мен фитингтерін өндіру, сату және монтаждау. Сумен жабдықтау, кәріз, кабель қорғау. Диаметрі 16-250 мм, 5 / 6 / 12 м кесінділер және орамдар.",
...
"nav.ft":"Фитингтер","nav.mt":"Монтаж","pc.mt":"<b>+</b> монтаж","b.mont":"Монтажды есептеу",
"mt.k":"Монтаж","mt.h":"Сатамыз әрі <em>монтаждаймыз</em>","mt.l":"Каталогтағының бәрін монтаждаймыз: құбырлар, фитингтер, тораптар. Материал да, жұмыс та - бір компаниядан.",
"mt1.h":"Су құбыры","mt1.p":"Сыртқы желілер және үйге су кіргізу.","mt2.h":"Кәріз","mt2.p":"Қысымды және қысымсыз желілер, нөсер кәрізі, дренаж.",
"mt3.h":"Кабель желілері","mt3.p":"Күштік және оптикалық кабельге қорғаныш құбырын төсеу.","mt4.h":"Фитингтер мен суару","mt4.p":"Тораптарды, шүмектерді және суару жүйелерін жинау.",
"mt.ck":"Толық цикл","mt.ch":"Материал мен монтаж бірге","mt.cp":"Нысанды және жұмыс көлемін жазыңыз - құбырларды, фитингтерді және монтажды есептейміз.","b.fprice":"Фитинг прайсы","a.ftabs":"Фитингтер бөлімі",
...
ru:{
  ...
  mont:"Здравствуйте! Нужен монтаж ПНД труб.\nОбъект и объём работ: "
},
kk:{
  ...
  mont:"Сәлеметсіз бе! ПНД құбырларын монтаждау керек.\nНысан және жұмыс көлемі: "
}};

var TICK = ["Водоснабжение","Канализация","Защита кабеля","Фитинги","Монтаж","Ø16-250 мм","Бухты и отрезки","ПЭ100","ГОСТ","Своё производство"];
var TICK_KZ = ["Сумен жабдықтау","Кәріз","Кабель қорғау","Фитингтер","Монтаж","Ø16-250 мм","Орамдар мен кесінділер","ПЭ100","ГОСТ","Өз өндірісіміз"];
